...
ROOT_DIR_CITYSCAPES = './data'
MODEL_PATH = "./model.pt"

EVAL = True
PLOT_LOSS = True

def save_predictions(data, model, location='./saved_images/multiclass_1/unet'):    
    model.eval()
    with torch.no_grad():
...
def evaluate(
    ...
    location='./saved_images/multiclass_1/unet'
    ):
    ...
    save_predictions(val_set, net, location)
